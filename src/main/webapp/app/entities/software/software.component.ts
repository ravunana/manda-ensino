...
export class SoftwareComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.softwareService
        ...
        .subscribe(
          (res: HttpResponse<ISoftware[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInSoftwares(): void {
    this.eventSubscriber = this.eventManager.subscribe('softwareListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ISoftware[] | null, headers: HttpHeaders, page: number): void {
