...
export class SalaComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.salaService
        ...
        .subscribe(
          (res: HttpResponse<ISala[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInSalas(): void {
    this.eventSubscriber = this.eventManager.subscribe('salaListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ISala[] | null, headers: HttpHeaders, page: number): void {
