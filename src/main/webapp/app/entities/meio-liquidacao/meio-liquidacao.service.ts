...
export class MeioLiquidacaoService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/meio-liquidacaos';
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IMeioLiquidacao[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
