...
export class MatriculaComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.matriculaService
        ...
        .subscribe(
          (res: HttpResponse<IMatricula[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInMatriculas(): void {
    this.eventSubscriber = this.eventManager.subscribe('matriculaListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IMatricula[] | null, headers: HttpHeaders, page: number): void {
