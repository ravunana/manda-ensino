...
export class MoradaPessoaService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/morada-pessoas';
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IMoradaPessoa[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
