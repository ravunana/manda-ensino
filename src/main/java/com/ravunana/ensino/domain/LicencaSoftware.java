 ...
 */
@Entity
@Table(name = "rv_licenca_software")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@org.springframework.data.elasticsearch.annotations.Document(indexName = "licencasoftware")
public class LicencaSoftware implements Serializable {
    ...
    @Min(value = 1)
    @Column(name = "numero_instituicao_ensino")
    ...
    public LicencaSoftware numeroInstituicaoEnsino(Integer numeroInstituicaoEnsino) {
    ...
    public LicencaSoftware instituicaoEnsino(InstituicaoEnsino instituicaoEnsino) {
