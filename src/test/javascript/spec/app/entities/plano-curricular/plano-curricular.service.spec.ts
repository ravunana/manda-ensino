...
describe('Service Tests', () => {
  describe('PlanoCurricular Service', () => {
    ...
    let elemDefault: IPlanoCurricular;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(PlanoCurricularService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new PlanoCurricular(0, 0, 'AAAAAAA', false, 'AAAAAAA', 'AAAAAAA');
    });
