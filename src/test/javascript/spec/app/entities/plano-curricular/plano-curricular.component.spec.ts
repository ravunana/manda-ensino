...
import { PlanoCurricularComponent } from 'app/entities/plano-curricular/plano-curricular.component';
...
describe('Component Tests', () => {
  describe('PlanoCurricular Management Component', () => {
    let comp: PlanoCurricularComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PlanoCurricularComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.planoCurriculars && comp.planoCurriculars[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
