...
import { RequerimentoComponent } from 'app/entities/requerimento/requerimento.component';
...
describe('Component Tests', () => {
  describe('Requerimento Management Component', () => {
    let comp: RequerimentoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RequerimentoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.requerimentos && comp.requerimentos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
