...
import { SoftwareComponent } from 'app/entities/software/software.component';
...
describe('Component Tests', () => {
  describe('Software Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.softwares && comp.softwares[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
