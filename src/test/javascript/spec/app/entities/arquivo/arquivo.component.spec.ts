...
import { ArquivoComponent } from 'app/entities/arquivo/arquivo.component';
  ...
  describe('Arquivo Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ArquivoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.arquivos && comp.arquivos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
