...
import { LookupItemComponent } from 'app/entities/lookup-item/lookup-item.component';
...
describe('Component Tests', () => {
  describe('LookupItem Management Component', () => {
    let comp: LookupItemComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LookupItemComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.lookupItems && comp.lookupItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
