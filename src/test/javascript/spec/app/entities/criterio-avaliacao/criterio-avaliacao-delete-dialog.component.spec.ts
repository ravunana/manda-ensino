...
import { CriterioAvaliacaoDeleteDialogComponent } from 'app/entities/criterio-avaliacao/criterio-avaliacao-delete-dialog.component';
  ...
  describe('CriterioAvaliacao Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [CriterioAvaliacaoDeleteDialogComponent]
      })
