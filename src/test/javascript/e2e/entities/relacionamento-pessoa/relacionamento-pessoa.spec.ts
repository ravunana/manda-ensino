...
describe('RelacionamentoPessoa e2e test', () => {
  ...
  it('should load RelacionamentoPessoas', async () => {
    ...
    expect(await relacionamentoPessoaComponentsPage.getTitle()).to.eq('ensinoApp.relacionamentoPessoa.home.title');
  });
  ...
  it('should load create RelacionamentoPessoa page', async () => {
    ...
    expect(await relacionamentoPessoaUpdatePage.getPageTitle()).to.eq('ensinoApp.relacionamentoPessoa.home.createOrEditLabel');
  ...
  /*  it('should delete last RelacionamentoPessoa', async () => {
        ...
        expect(await relacionamentoPessoaDeleteDialog.getDialogTitle())
            .to.eq('ensinoApp.relacionamentoPessoa.delete.question');
