...
describe('Arquivo e2e test', () => {
  ...
  it('should load Arquivos', async () => {
    ...
    expect(await arquivoComponentsPage.getTitle()).to.eq('ensinoApp.arquivo.home.title');
  });
  ...
  it('should load create Arquivo page', async () => {
    ...
    expect(await arquivoUpdatePage.getPageTitle()).to.eq('ensinoApp.arquivo.home.createOrEditLabel');
  ...
  it('should create and save Arquivos', async () => {
    ...
    await promise.all([
      ...
      arquivoUpdatePage.setEntidadeInput('entidade'),
    ...
    expect(await arquivoUpdatePage.getEntidadeInput()).to.eq('entidade', 'Expected Entidade value to be equals to entidade');
  ...
  it('should delete last Arquivo', async () => {
    ...
    expect(await arquivoDeleteDialog.getDialogTitle()).to.eq('ensinoApp.arquivo.delete.question');
