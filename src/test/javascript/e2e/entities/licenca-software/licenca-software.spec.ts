...
describe('LicencaSoftware e2e test', () => {
  ...
  it('should load LicencaSoftwares', async () => {
    ...
    expect(await licencaSoftwareComponentsPage.getTitle()).to.eq('ensinoApp.licencaSoftware.home.title');
  });
  ...
  it('should load create LicencaSoftware page', async () => {
    ...
    expect(await licencaSoftwareUpdatePage.getPageTitle()).to.eq('ensinoApp.licencaSoftware.home.createOrEditLabel');
  ...
  /*  it('should create and save LicencaSoftwares', async () => {
        ...
        await promise.all([
            ...
            licencaSoftwareUpdatePage.setNumeroInstituicaoEnsinoInput('5'),
            licencaSoftwareUpdatePage.softwareSelectLastOption(),
            licencaSoftwareUpdatePage.instituicaoEnsinoSelectLastOption(),
        ]);
        ...
        expect(await licencaSoftwareUpdatePage.getNumeroInstituicaoEnsinoInput()).to.eq('5', 'Expected numeroInstituicaoEnsino value to be equals to 5');
  ...
  /*  it('should delete last LicencaSoftware', async () => {
        ...
        expect(await licencaSoftwareDeleteDialog.getDialogTitle())
            .to.eq('ensinoApp.licencaSoftware.delete.question');
