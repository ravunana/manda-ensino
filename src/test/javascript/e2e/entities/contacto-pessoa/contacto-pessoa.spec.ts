...
describe('ContactoPessoa e2e test', () => {
  ...
  it('should load ContactoPessoas', async () => {
    ...
    expect(await contactoPessoaComponentsPage.getTitle()).to.eq('ensinoApp.contactoPessoa.home.title');
  });
  ...
  it('should load create ContactoPessoa page', async () => {
    ...
    expect(await contactoPessoaUpdatePage.getPageTitle()).to.eq('ensinoApp.contactoPessoa.home.createOrEditLabel');
  ...
  /*  it('should delete last ContactoPessoa', async () => {
        ...
        expect(await contactoPessoaDeleteDialog.getDialogTitle())
            .to.eq('ensinoApp.contactoPessoa.delete.question');
