...
describe('CoordenadaBancaria e2e test', () => {
  ...
  it('should load CoordenadaBancarias', async () => {
    ...
    expect(await coordenadaBancariaComponentsPage.getTitle()).to.eq('ensinoApp.coordenadaBancaria.home.title');
  });
  ...
  it('should load create CoordenadaBancaria page', async () => {
    ...
    expect(await coordenadaBancariaUpdatePage.getPageTitle()).to.eq('ensinoApp.coordenadaBancaria.home.createOrEditLabel');
  ...
  /*  it('should create and save CoordenadaBancarias', async () => {
        ...
        await promise.all([
            ...
            // coordenadaBancariaUpdatePage.instituicaoEnsinoSelectLastOption(),
        ]);
  ...
  /*  it('should delete last CoordenadaBancaria', async () => {
        ...
        expect(await coordenadaBancariaDeleteDialog.getDialogTitle())
            .to.eq('ensinoApp.coordenadaBancaria.delete.question');
