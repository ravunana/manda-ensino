...
describe('LookupItem e2e test', () => {
  ...
  it('should load LookupItems', async () => {
    ...
    expect(await lookupItemComponentsPage.getTitle()).to.eq('ensinoApp.lookupItem.home.title');
  });
  ...
  it('should load create LookupItem page', async () => {
    ...
    expect(await lookupItemUpdatePage.getPageTitle()).to.eq('ensinoApp.lookupItem.home.createOrEditLabel');
  ...
  it('should delete last LookupItem', async () => {
    ...
    expect(await lookupItemDeleteDialog.getDialogTitle()).to.eq('ensinoApp.lookupItem.delete.question');
