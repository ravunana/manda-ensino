...
describe('MoradaPessoa e2e test', () => {
  ...
  it('should load MoradaPessoas', async () => {
    ...
    expect(await moradaPessoaComponentsPage.getTitle()).to.eq('ensinoApp.moradaPessoa.home.title');
  });
  ...
  it('should load create MoradaPessoa page', async () => {
    ...
    expect(await moradaPessoaUpdatePage.getPageTitle()).to.eq('ensinoApp.moradaPessoa.home.createOrEditLabel');
  ...
  /*  it('should delete last MoradaPessoa', async () => {
        ...
        expect(await moradaPessoaDeleteDialog.getDialogTitle())
            .to.eq('ensinoApp.moradaPessoa.delete.question');
