...
describe('MeioLiquidacao e2e test', () => {
  ...
  it('should load MeioLiquidacaos', async () => {
    ...
    expect(await meioLiquidacaoComponentsPage.getTitle()).to.eq('ensinoApp.meioLiquidacao.home.title');
  });
  ...
  it('should load create MeioLiquidacao page', async () => {
    ...
    expect(await meioLiquidacaoUpdatePage.getPageTitle()).to.eq('ensinoApp.meioLiquidacao.home.createOrEditLabel');
  ...
  it('should delete last MeioLiquidacao', async () => {
    ...
    expect(await meioLiquidacaoDeleteDialog.getDialogTitle()).to.eq('ensinoApp.meioLiquidacao.delete.question');
