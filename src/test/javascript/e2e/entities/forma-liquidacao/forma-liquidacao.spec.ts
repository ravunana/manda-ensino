...
describe('FormaLiquidacao e2e test', () => {
  ...
  it('should load FormaLiquidacaos', async () => {
    ...
    expect(await formaLiquidacaoComponentsPage.getTitle()).to.eq('ensinoApp.formaLiquidacao.home.title');
  });
  ...
  it('should load create FormaLiquidacao page', async () => {
    ...
    expect(await formaLiquidacaoUpdatePage.getPageTitle()).to.eq('ensinoApp.formaLiquidacao.home.createOrEditLabel');
  ...
  it('should delete last FormaLiquidacao', async () => {
    ...
    expect(await formaLiquidacaoDeleteDialog.getDialogTitle()).to.eq('ensinoApp.formaLiquidacao.delete.question');
