...
describe('Software e2e test', () => {
  ...
  it('should load Softwares', async () => {
    ...
    expect(await softwareComponentsPage.getTitle()).to.eq('ensinoApp.software.home.title');
  });
  ...
  it('should load create Software page', async () => {
    ...
    expect(await softwareUpdatePage.getPageTitle()).to.eq('ensinoApp.software.home.createOrEditLabel');
  ...
  it('should create and save Softwares', async () => {
    ...
    await softwareComponentsPage.clickOnCreateButton();
    await promise.all([
      softwareUpdatePage.setInstituicaoEnsinoInput('instituicaoEnsino'),
    ...
    expect(await softwareUpdatePage.getInstituicaoEnsinoInput()).to.eq(
      'instituicaoEnsino',
      'Expected InstituicaoEnsino value to be equals to instituicaoEnsino'
    );
  ...
  it('should delete last Software', async () => {
    ...
    expect(await softwareDeleteDialog.getDialogTitle()).to.eq('ensinoApp.software.delete.question');
